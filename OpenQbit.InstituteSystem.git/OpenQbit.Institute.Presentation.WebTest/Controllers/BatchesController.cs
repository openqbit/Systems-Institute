...
namespace OpenQbit.Institute.Presentation.WebTest.Controllers
{
    public class BatchesController : Controller
    {
        ...
        {
            var batch = db.Batch.Include(b => b.Branch);
        ...
        public ActionResult Create([Bind(Include = "BatchId,BatchName,BranchId")] Batch batch)
        {
            ...
            ViewBag.BranchId = new SelectList(db.Branch, "BranchId", "BranchName", batch.BranchId);
            return View(batch);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BatchId,BatchName,BranchId")] Batch batch)
        {
            if (ModelState.IsValid)
            {
