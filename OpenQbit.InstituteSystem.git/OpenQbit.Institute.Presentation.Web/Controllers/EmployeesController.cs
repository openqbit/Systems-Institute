...
namespace OpenQbit.Institute.Presentation.Web.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            ViewBag.PersonID = new SelectList(db.Person, "PersonId", "PersonName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "EmployeeID,EmployeeType,PersonID")] Employee employee)
        {
            ...
            ViewBag.PersonID = new SelectList(db.Person, "PersonId", "PersonName", employee.PersonID);
            return View(employee);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeID,EmployeeType,PersonID")] Employee employee)
        {
            if (ModelState.IsValid)
            {
